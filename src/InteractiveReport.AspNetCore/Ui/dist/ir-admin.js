var k=class extends Error{constructor(e,t){let r=[];e.title&&r.push(e.title),e.detail&&r.push(e.detail);for(let o of Object.values(e.errors??{}))for(let s of o)r.push(s);super(r.join(" \u2014 ")||`HTTP ${t}`),this.name="ApiError",this.status=t,this.problem=e,this.errors=e.errors??null,this.traceId=e.traceId??null}};async function I(n){let e=await n.json().catch(()=>({}));return new k(e,n.status)}async function u(n,{method:e="GET",body:t,signal:r}={}){let o=await fetch(n,{method:e,signal:r,headers:t!==void 0?{"Content-Type":"application/json"}:void 0,body:t!==void 0?JSON.stringify(t):void 0});if(!o.ok)throw await I(o);return o.status===204?null:o.json()}var A=`/* InteractiveReport widget theme \u2014 an APEX Universal-Theme-flavored skin.
...
`;function i(n,e={},...t){let r=document.createElement(n);for(let[o,s]of Object.entries(e))s!=null&&(o==="class"?r.className=s:o==="part"?r.setAttribute("part",s):o==="for"?r.htmlFor=s:o==="dataset"?Object.assign(r.dataset,s):o==="style"?Object.assign(r.style,s):o.startsWith("on")||o in r?r[o]=s:r.setAttribute(o,s));return r.append(...t.flat(1/0).filter(o=>o!=null&&o!==!1)),r}function D(n){let e=n.attachShadow({mode:"open"}),t=i("style",{"data-ir-styles":""});t.textContent=A;let r=i("div",{part:"surface"});return e.append(t,r),{root:e,mount:r}}var H={search:'<svg viewBox="0 0 16 16" width="14" height="14" aria-hidden="true"><circle cx="6.5" cy="6.5" r="4.5" fill="none" stroke="currentColor" stroke-width="1.6"/><line x1="10" y1="10" x2="14" y2="14" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>',caret:'<svg viewBox="0 0 16 16" width="10" height="10" aria-hidden="true"><path d="M3 5.5 8 11l5-5.5" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>',grid:'<svg viewBox="0 0 16 16" width="14" height="14" aria-hidden="true"><path d="M1.5 2.5h13v11h-13z M1.5 6h13 M1.5 9.5h13 M6 2.5v11 M11 2.5v11" fill="none" stroke="currentColor" stroke-width="1.2"/></svg>',group:'<svg viewBox="0 0 16 16" width="14" height="14" aria-hidden="true"><rect x="1.5" y="2" width="6" height="3" fill="currentColor" opacity=".55"/><rect x="1.5" y="6.5" width="10" height="3" fill="currentColor" opacity=".8"/><rect x="1.5" y="11" width="13" height="3" fill="currentColor"/></svg>',pivot:'<svg viewBox="0 0 16 16" width="14" height="14" aria-hidden="true"><path d="M1.5 2.5h13v11h-13z M1.5 6h13 M6 2.5v11" fill="none" stroke="currentColor" stroke-width="1.2"/><circle cx="10.5" cy="10" r="1.4" fill="currentColor"/></svg>',close:'<svg viewBox="0 0 16 16" width="10" height="10" aria-hidden="true"><path d="M3 3l10 10M13 3L3 13" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>'};function j(n){let e=i("span",{class:"ir-icon","aria-hidden":"true"});return e.innerHTML=H[n]??"",e}function v(n,e,t){return i("div",{class:`ir-banner ir-banner-${n}`},i("span",{class:"ir-banner-text"},e),t?i("button",{type:"button",class:"ir-banner-x","aria-label":"Dismiss",onclick:t},j("close")):null)}var O=null,B=null,m=new WeakMap;function M(){O?.(),O=null,B=null}function U(n){B===n&&M();for(let e of[...m.get(n)??[]])e.close();m.delete(n)}function w({owner:n,title:e,width:t,cls:r,build:o,applyLabel:s="Apply",onApply:c,destructive:y=!1}){M();let f=n?.shadowRoot??document,P=f instanceof ShadowRoot?f:document.body,_=f.activeElement??document.activeElement,h=i("div",{class:"ir-dialog-error",hidden:!0}),b=i("div",{class:"ir-dialog-body"}),g=null;n&&(g=m.get(n)??new Set,m.set(n,g));let C=!1,l={root:null,body:b,close(){C||(C=!0,l.root.remove(),document.removeEventListener("keydown",S,!0),g?.delete(l),_?.focus?.())},setError(a){if(h.replaceChildren(),a==null){h.hidden=!0;return}let d=[];if(a.errors&&typeof a.errors=="object"){a.problem?.title&&d.push(a.problem.title);for(let p of Object.values(a.errors))d.push(...p)}else d.push(typeof a=="string"?a:a.message||"Something went wrong.");h.append(...d.map(p=>i("div",{},p))),h.hidden=!1}},x=c?i("button",{type:"button",class:"ir-btn ir-btn-primary"+(y?" ir-btn-danger":""),onclick:async()=>{l.setError(null);let a=l.root.querySelectorAll(".ir-dialog-footer button");a.forEach(d=>d.disabled=!0);try{await c(l),l.close()}catch(d){l.setError(d)}finally{a.forEach(d=>d.disabled=!1)}}},s):null,E=i("button",{type:"button",class:"ir-btn",onclick:()=>l.close()},c?"Cancel":"Close");l.root=i("div",{class:"ir-overlay"+(r?` ${r}`:""),part:"dialog-overlay"},i("div",{class:"ir-dialog",part:"dialog",role:"dialog","aria-modal":"true",style:t?{width:t}:{}},i("div",{class:"ir-dialog-title"},e,i("button",{type:"button",class:"ir-dialog-x","aria-label":"Close",onclick:()=>l.close()},j("close"))),h,b,i("div",{class:"ir-dialog-footer"},E,x)));let S=a=>{if(a.key==="Escape"){a.stopPropagation(),l.close();return}let d=a.composedPath?.()[0]??a.target;if(a.key==="Enter"&&x&&d.tagName!=="TEXTAREA"&&d.tagName!=="BUTTON"){a.preventDefault(),x.click();return}if(a.key!=="Tab")return;let p=[...l.root.querySelectorAll("button, input, select, textarea, [tabindex]")].filter(R=>!R.disabled&&R.offsetParent!==null);if(!p.length)return;let $=p[0],T=p[p.length-1],L=f.activeElement??document.activeElement;a.shiftKey&&L===$?(a.preventDefault(),T.focus()):!a.shiftKey&&L===T&&(a.preventDefault(),$.focus())};return document.addEventListener("keydown",S,!0),o(b,l),P.append(l.root),g?.add(l),(b.querySelector("input, select, textarea")??x??E).focus(),l}function q(n,e,t,r="Delete"){return new Promise(o=>{let s=!1,c=w({owner:n,title:e,width:"26rem",applyLabel:r,destructive:!0,build:f=>f.append(i("p",{class:"ir-confirm-text"},t)),onApply:()=>{s=!0}}),y=c.close;c.close=()=>{y(),o(s)}})}function N(n,e,t={}){return i("label",{class:"ir-field"+(t.inline?" ir-field-inline":"")},i("span",{class:"ir-field-label"},n),e)}var W=new URL("..",import.meta.url).pathname.replace(/\/$/,""),z=class extends HTMLElement{static observedAttributes=["api-base","base"];constructor(){super();let{root:e,mount:t}=D(this);this._root=e,this._mount=t,this._seq=0}get apiBase(){return this.getAttribute("api-base")??this.getAttribute("base")??W}set apiBase(e){e==null?this.removeAttribute("api-base"):this.setAttribute("api-base",String(e))}get base(){return this.apiBase.replace(/\/+$/,"")}connectedCallback(){this._connected=!0,this.init()}disconnectedCallback(){this._connected=!1,++this._seq,U(this)}attributeChangedCallback(e,t,r){this._connected&&t!==r&&this.init()}async init(){let e=++this._seq;this.rows=[],this.whoami=null;let t=i("input",{class:"ir-input",type:"search",placeholder:"Filter by report, title, owner\u2026",oninput:()=>this.renderTable()});this.els={filter:t,count:i("span",{class:"ir-admin-count"}),identity:i("span",{class:"ir-admin-count"}),errorSlot:i("div",{}),transientSlot:i("div",{}),body:i("div",{class:"ir-tablewrap",part:"table-container"})},this._mount.replaceChildren(i("div",{class:"ir-admin-bar",part:"toolbar"},t,i("button",{type:"button",class:"ir-btn",onclick:()=>this.reload()},"Refresh"),this.els.count,i("span",{class:"ir-spacer"}),this.els.identity),i("div",{class:"ir-notices",part:"notices"},this.els.errorSlot,this.els.transientSlot),this.els.body),this.whoami=await u(`${this.base}/whoami`).catch(()=>null),!(e!==this._seq||!this.isConnected)&&(this.whoami?.identity&&(this.els.identity.textContent=`Signed in as ${this.whoami.identity}`),await this.reload())}async reload(){let e=this._seq;this.els.errorSlot.replaceChildren();try{let t=await u(`${this.base}/admin/saved`);if(e!==this._seq||!this.isConnected)return;this.rows=t,this.renderTable()}catch(t){if(e!==this._seq||!this.isConnected)return;let r=t.status===401?"Sign in to administer saved reports.":t.status===404?"Administrator access required. Add your identity to InteractiveReport:Administrators.":t.message;this.els.body.replaceChildren(),this.els.errorSlot.replaceChildren(v("error",r))}}notify(e){let t=v("ok",e);this.els.transientSlot.append(t),setTimeout(()=>t.remove(),4e3)}fail(e){this.els.errorSlot.replaceChildren(v("error",e.message,()=>this.els.errorSlot.replaceChildren()))}filtered(){let e=this.els.filter.value.trim().toLowerCase();return e?this.rows.filter(t=>[t.reportName,t.title,t.owner].some(r=>(r??"").toLowerCase().includes(e))):this.rows}renderTable(){let e=this.filtered();this.els.count.textContent=e.length===this.rows.length?`${this.rows.length} saved`:`${e.length} of ${this.rows.length} saved`;let t=(o,s,c)=>i("button",{type:"button",class:"ir-linkbtn"+(c?" ir-linkbtn-danger":""),onclick:s},o),r=e.map(o=>i("tr",{class:"ir-row"},i("td",{},o.reportName),i("td",{},o.title),i("td",{},o.owner),i("td",{},i("span",{class:"ir-badge "+(o.isGlobal?"ir-badge-global":"ir-badge-private")},o.isGlobal?"Global":"Private")),i("td",{class:"ir-date"},F(o.modifiedUtc)),i("td",{class:"ir-actions-cell"},t(o.isGlobal?"Unpublish":"Publish",()=>this.setGlobal(o,!o.isGlobal))," \xB7 ",t("Reassign\u2026",()=>this.reassign(o))," \xB7 ",t("State",()=>this.viewState(o))," \xB7 ",t("Delete\u2026",()=>this.remove(o),!0))));r.length||r.push(i("tr",{class:"ir-empty"},i("td",{colSpan:6},"No saved reports."))),this.els.body.replaceChildren(i("table",{class:"ir-table",part:"table"},i("thead",{},i("tr",{},...["Report","Title","Owner","Scope","Modified",""].map(o=>i("th",{scope:"col"},o)))),i("tbody",{},...r)))}async setGlobal(e,t){try{await u(`${this.base}/saved/${encodeURIComponent(e.id)}`,{method:"PUT",body:{isGlobal:t}}),this.notify(t?`"${e.title}" is now global.`:`"${e.title}" is now private to ${e.owner}.`),await this.reload()}catch(r){this.fail(r)}}reassign(e){let t=i("input",{class:"ir-input",type:"text",value:e.owner});w({owner:this,title:"Reassign Owner",width:"26rem",applyLabel:"Reassign",build:r=>r.append(i("p",{class:"ir-confirm-text"},`"${e.title}" (${e.reportName})`),N("New owner (identity value)",t),i("p",{class:"ir-dialog-note"},"The exact identity value \u2014 what GET \u2026/whoami reports for that user.")),onApply:async()=>{let r=t.value.trim();if(!r)throw new Error("Enter an identity value");await u(`${this.base}/saved/${encodeURIComponent(e.id)}`,{method:"PUT",body:{owner:r}}),this.notify(`"${e.title}" reassigned to ${r}.`),await this.reload()}})}async viewState(e){try{let t=await u(`${this.base}/saved/${encodeURIComponent(e.id)}`);w({owner:this,title:`${e.title} \u2014 state document`,width:"36rem",build:r=>r.append(i("pre",{class:"ir-state-pre"},JSON.stringify(t.state,null,2)))})}catch(t){this.fail(t)}}async remove(e){let t=e.isGlobal?"the GLOBAL report":`${e.owner}'s report`;if(await q(this,"Delete Saved Report",`Delete ${t} "${e.title}"? This cannot be undone.`))try{await u(`${this.base}/saved/${encodeURIComponent(e.id)}`,{method:"DELETE"}),this.notify(`"${e.title}" deleted.`),await this.reload()}catch(r){this.fail(r)}}};function F(n){let e=new Date(n);return Number.isNaN(e.valueOf())?n??"":e.toLocaleString()}customElements.get("interactive-report-admin")||customElements.define("interactive-report-admin",z);
